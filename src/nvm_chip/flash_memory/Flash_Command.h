...
#define CMD_READ_PAGE_MULTISUPERBLOCK 0x0032
...
#define CMD_READ_PAGE_COPYBACK_MULTISUPERBLOCK 0x00321 //since the codes of multisuperblock copyback (i.e., 0x0032) and multisuperblock read (i.e., 0x0032) are identical, we change the code of multisuperblock copyback 0x0032 to 0x00321 so that we can differentiate copyback multisuperblock from normal multisuperblock
#define CMD_PROGRAM 0x8000
#define CMD_PROGRAM_PAGE 0x8010
#define CMD_PROGRAM_PAGE_MULTIPLANE 0x8011
#define CMD_PROGRAM_PAGE_MULTISUPERBLOCK 0x8011
...
#define CMD_PROGRAM_PAGE_COPYBACK_MULTISUPERBLOCK 0x85111 //since the codes of multisuperblock copyback (i.e., 0x8511) and multisuperblock program (i.e., 0x8511) are identical, we change the code of multisuperblock copyback 0x8511 to 0x85111 so that we can differentiate copyback multisuperblock from normal multisuperblock
...
#define CMD_ERASE_BLOCK_MULTISUPERBLOCK 0x60D1
