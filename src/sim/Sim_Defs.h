...
#define DEBUG_MAEE(M)// std::cout<<M<<std::endl;

#define target_debug_channel 4
#define target_debug_chip 3
#define target_debug_die 1
#define target_debug_plane 0

#define maee_debug_enabled 0
#define maee_analyze_enabled 0
#define _debug_by_maee(M) if(maee_debug_enabled){M}
#define _analyze_by_maee(M) if(maee_analyze_enabled){M}
#endif // !DEFINITIONS_H
