...
namespace SSD_Components
{
	...
	bool Address_Mapping_Unit_Hybrid::query_cmt(NVM_Transaction_Flash* transaction)
	{
		return true;
	}

	bool Address_Mapping_Unit_Hybrid::query_cmt(NVM_Transaction_Flash* transaction, const std::list<NVM_Transaction*>& transactionList) 
	{
		return true; 
	}
	...
	void Address_Mapping_Unit_Hybrid::Set_barrier_for_accessing_physical_superblock(const NVM::FlashMemory::Physical_Page_Address& superblock_address) {}
