...
namespace SSD_Components
{
	...
	*/
	...
	public:
		...
		virtual void Check_gc_required_die(const unsigned int BlockPoolSize, const NVM::FlashMemory::Physical_Page_Address& planeAddress) = 0;
	...
	protected:
		...
		bool is_safe_gc_wl_candidate_superblock(const DieBookKeepingType* dpke, const flash_superblock_ID_type gc_wl_candidate_superblock_id); //Checks if superblock_address is a safe candidate for gc execution, i.e., 1) it is not a write frontier, and 2) there is no ongoing program operation
