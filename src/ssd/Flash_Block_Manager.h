...
namespace SSD_Components
{
	...
	public:
		...
		//------------------------------- ADDED BY MAEE --------------------------------------------
		//void Add_erased_superblock_to_pool(const NVM::FlashMemory::Physical_Page_Address& address);
		void check_if_a_superblock_erased(const NVM::FlashMemory::Physical_Page_Address& address);
		//------------------------------------------------------------------------------------------
