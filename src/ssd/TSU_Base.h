...
public:
	TransactionBound(PPA_type offset, unsigned int planeVector) {
		this->offset = offset;
	...
	PPA_type offset;
	std::list<NVM_Transaction_Flash*> transaction_dispatch_slots;
	sim_time_type minimum_initiate_time;
};
//--------------------------------------------------------------------------
...
protected:
	...
	bool basic_issue_command_to_chip(Flash_Transaction_Queue *sourceQueue1, Flash_Transaction_Queue *sourceQueue2, Transaction_Type transactionType, bool suspensionRequired);
	bool issue_command_to_chip_with_bounding(Flash_Transaction_Queue *sourceQueue1, Flash_Transaction_Queue *sourceQueue2, Transaction_Type transactionType, bool suspensionRequired);
	bool issue_command_to_chip_using_RL(Flash_Transaction_Queue *sourceQueue1, Flash_Transaction_Queue *sourceQueue2, Transaction_Type transactionType, bool suspensionRequired);
